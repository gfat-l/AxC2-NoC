...
SC_MODULE(NoximNoC)
{
    ...
    sc_signal <TBufferFullStatus> ack_to_east[MAX_STATIC_DIM + 1][MAX_STATIC_DIM + 1][MAX_STATIC_DIM + 1];
    sc_signal <TBufferFullStatus> ack_to_west[MAX_STATIC_DIM + 1][MAX_STATIC_DIM + 1][MAX_STATIC_DIM + 1];
    sc_signal <TBufferFullStatus> ack_to_south[MAX_STATIC_DIM + 1][MAX_STATIC_DIM + 1][MAX_STATIC_DIM + 1];
    sc_signal <TBufferFullStatus> ack_to_north[MAX_STATIC_DIM + 1][MAX_STATIC_DIM + 1][MAX_STATIC_DIM + 1];
	sc_signal <TBufferFullStatus> ack_to_up[MAX_STATIC_DIM+1][MAX_STATIC_DIM+1][MAX_STATIC_DIM+1]; 
	sc_signal <TBufferFullStatus> ack_to_down[MAX_STATIC_DIM+1][MAX_STATIC_DIM+1][MAX_STATIC_DIM+1];
