...
SC_MODULE(NoximTile)
{
    ...
    sc_out <TBufferFullStatus> ack_rx[DIRECTIONS];	        // The outgoing ack signals associated with the input channels
    ...
    sc_in <TBufferFullStatus> ack_tx[DIRECTIONS];	        // The outgoing ack signals associated with the output channels
    ...
    sc_signal <TBufferFullStatus> ack_rx_local;	        // The outgoing ack signals associated with the input channels
    ...
    sc_signal <TBufferFullStatus> ack_tx_local;	        // The outgoing ack signals associated with the output channels
